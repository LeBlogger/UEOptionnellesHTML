...
$adminHeader = '<div class="header">
        <h3 class="text-muted" style="text-align:center">Inscriptions pédagogiques</h3>
      </div>';
...
$footer = '<div class="footer">
        ...
        <a class="FR" href="/Home.php">Déconnexion (Soufiane)</a>
      </div>';
      
      
$adminMenu = ' <div class="">
      	<ul class="nav nav-tabs nav-justified">
			<li class="active"><a href="/recapChoix.php">Choix</a></li>
			<li><a href="/Emargements.php">Feuilles émargement</a></li>
			<li><a href="/Etudiants.php">Etudiants</a></li>
			<li><a href="/Maquette.php">Maquette</a></li>
			<li><a href="/UE.php">UEs</a></li>
			<li><a href="/Parcours.php">Années</a></li>
